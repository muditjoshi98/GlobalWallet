...
import 'package:global_wallet/new_transaction.dart';

class WalletSelectionPage extends StatelessWidget {

  final String amount;
  final String id;
  WalletSelectionPage(this.amount, this.id);
  ...
  void showAppModal(String service, String image, String merchant, BuildContext context){
    ...
    builder: (bctx)=>NewTransaction(service,image,merchant,amount,id),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Global Wallet::Add Money"),
      ),
